...
suite('UnitTests', function() {
    suite('Routing Tests - Unit Tests', function() {
        ...
        test('String should be 81 characters long', function(done) {
            ...
            let completeSolution = '135762984946381257728459613694517832812936745357824196473298561581673429269145378';
            assert.equal(solver.solve(inputString), completeSolution);
            done();
        });
